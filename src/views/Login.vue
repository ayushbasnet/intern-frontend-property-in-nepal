          ...
          <v-row class="ma-0 ">
            ...
            <v-col  class="col-12 ">
              <div class="form ">
                ...
                <ValidationObserver ref="loginObserver" v-slot="{ handleSubmit }">
                  <form ref="loginForm" @submit.prevent="handleSubmit(loginNow)">
                    <v-container>
                      <v-row>
                        <v-col class="col-12">
                          <ValidationProvider rules="username" vid="username" v-slot="{ errors }">
                            <v-text-field v-model="form.username" label="Username" autocomplete="off"   outlined
                        ...
                        <v-col>
                          <v-btn class="btn blue white--text " outlined size="x-large" type="submit" block> LOGIN </v-btn>
                      ...
                      <v-row>
                        ...
                        <v-col class="col-12">
                          ...
                          <v-btn block color="" class="mt-4" click="googleSignIn" >
        ...
        if (result) {
          ...
          this.$axios.post('#', this.form)
              ...
              .catch(error => {
                ...
                this.$refs.loginObserver.setErrors(this.errors);
              })
